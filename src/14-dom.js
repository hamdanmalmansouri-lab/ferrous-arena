...
const uiWave=$('uiWave'),uiLeft=$('uiLeft'),uiQueue=$('uiQueue'),uiScrap=$('uiScrap'),uiScore=$('uiScore'),uiKills=$('uiKills'),uiBossIn=$('uiBossIn');
