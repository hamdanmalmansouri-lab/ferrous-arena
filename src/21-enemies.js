...
function finishEnemy(g,type,wave,animator,bones,model,modelScale){
  ...
  const e={
    ...
    animator:animator, bones:bones, model:model||null, modelScale:modelScale||1, token:false, stun:0, burnT:0, burnTick:0, markT:0, slowT:0, attackT:0, shootT:0, animAcc:0, hitBoxes:[bodyHit,headHit]
  };
