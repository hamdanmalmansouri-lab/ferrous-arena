...
Current build: **v3.0.0-p6** (10 Sep 2026) — v3.0 "Meltdown" pass in progress (see the V3 table below). v2.8.0 (8 Sep 2026): Quaternius cast, UAL jump + reload, free look + RMB aim, kit props merged into the world, explosive barrels.
