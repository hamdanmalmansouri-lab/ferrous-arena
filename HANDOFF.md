...
**Status:** v3.0.0-p4 — the v3.0 "Meltdown" pass is in progress (phases 1 correctness, 2 roguelite loop, 3 art foundation, 4 game feel shipped; phases 2–7 in `MASTER-ROADMAP.md` V3 table). Base: playable v2.8 (roadmap phases 1, 2a/2b, 4, 3, 5 — performance, touch/gamepad, PWA, pathfinding + stages,
